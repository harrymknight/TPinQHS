...
void de 
( 
  void f ( double t, double y[], double yp[], double E, double V),
  double E,
  double V,
  int neqn,
  double y[], 
...
*/
    *h = r8_min ( r8_abs ( *h ), r8_abs ( tend - *x ) ) * r8_sign ( *h );
    ...
    stepper(x, yy, f, E, V, neqn, h, &eps, wt, start, hold, k, kold, &crash, phi, p, yp, psi, alpha, beta, sig, v, w, g, phase1, ns, nornd);
/*
