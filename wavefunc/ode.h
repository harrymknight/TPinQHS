void de ( void f ( double t, double y[], double yp[], double E, double V), double E, double V, int neqn, double y[], 
...
void ode ( void f ( double t, double y[], double yp[], double E, double V), double E, double V, int neqn, double y[], 
...
void stepper ( double *x, double y[], void f ( double t, double y[], double yp[], double E, double V), double E, double V,
