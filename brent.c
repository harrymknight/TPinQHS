...
double zero ( double a, double b, double machep, double t, 
  double _f(void (*f)(double x, double *y, double *yp, double E, double V), double *x, double xout, double E, double V, double x_0, const double igrad, double *y, double *yp
        ...
        double *x, double xout, double V, double x_0, const double igrad, double *y, double *yp, const int neqn, double relerr, double abserr, int *iflag, double *work, int *iwork)
...
*/
  sa = a;
  sb = b;
  fa = _f (f, x, xout, sa, V, x_0, igrad, y, yp, neqn, relerr, abserr, iflag, work, iwork);
  fb = _f (f, x, xout, sb, V, x_0, igrad, y, yp, neqn, relerr, abserr, iflag, work, iwork);
